  ...
  <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300&display=swap" rel="stylesheet">
    ...
    <div class="top-container">
        ...
        function handleRefreshRequest() {
            $communityID = $_SESSION['community'];
            $result = executePlainSQL("SELECT B.blogId, U.title, B.DATETIME_record 
            FROM BID B, UID_CID_DATETIME U WHERE B.communityID = $communityID 
            AND B.DATETIME_record = U.DATETIME_record AND B.userID = U.userID 
            AND B.communityID = U.communityID");
